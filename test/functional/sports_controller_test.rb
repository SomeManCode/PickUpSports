...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { address: @sport.address, game: @sport.game, latitude: @sport.latitude, longitude: @sport.longitude, needed: @sport.needed }
    end
  ...
  test "should update sport" do
    put :update, id: @sport, sport: { address: @sport.address, game: @sport.game, latitude: @sport.latitude, longitude: @sport.longitude, needed: @sport.needed }
    assert_redirected_to sport_path(assigns(:sport))
  end
